...
function ToDo() {
  ...
  return (
    <>
      ...
      <div>
        Addres: Street: {person.address.street} Suite: {person.address.suite}{" "}
        City: {person.address.city} Zipcode: {person.address.zipcode}
      </div>
      <div>
        Geo: {person.address.geo.lat} {person.address.geo.lng}
      </div>
      <div>Phone: {person.phone}</div>
      <div>Website: {person.website}</div>
      <div>
        Company: {person.company.name} CatchPhrase: {person.company.catchPhrase}{" "}
