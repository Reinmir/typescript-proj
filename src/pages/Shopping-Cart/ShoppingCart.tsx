              ...
              <div className={styles.count_wrapper}>
                <button
                  className={`${styles.remove} ${
                    mouseEnter === true ? styles.visible : styles.hidden
                  }`}
                  onClick={() => removeFromCart(item.person)}
                >
                  -
                </button>
                ...
                <button
                  ...
                  onClick={() => addToCart(item.person)}
                >
                  +
                </button>
                <button
                  className={`${styles.remove_x} ${
                    mouseEnter === true ? styles.visible : styles.hidden
                  }`}
                  onClick={() => removeCurPersonFromCart(item.person)}
                >
                  x
                </button>
              </div>
            </div>
            <div className={styles.personCart}>
              Name:{item.person.name} Height:{item.person.height}
            </div>
          </div>
        );
      })}
